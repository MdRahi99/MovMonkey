...
export default function CleaningSchedule({ formik, setCurrentStep }) {
  useScrollToTop();
  ...
  return (
    <div>
      <div className="flex min-h-16 items-center bg-primary text-2xl font-semibold text-black md:h-20 md:text-2xl lg:mt-10">
        <p className="mx-auto w-full max-w-7xl px-5 py-2">Schedule</p>
      </div>
          ...
          <div>
            <Popover>
                ...
                <PopoverTrigger asChild>
                  <Button
                    className={cn(
                      ...
                      formik.values.prefer_date && "text-black",
                    )}
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {formik.values.prefer_date ? (
                      format(formik.values.prefer_date, "PPP")
                    ) : (
              ...
              <PopoverContent className="w-auto p-0">
                <Calendar
                  mode="single"
                  selected={new Date(formik.values.prefer_date)}
                  onSelect={(date) => {
