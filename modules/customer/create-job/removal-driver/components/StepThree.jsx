      ...
      <div className="mb-10">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-5">
          <div
            ...
            onClick={() =>
              formik.setFieldValue("extra_moving_service", "PACKING_SERVICES")
            }
          >
            <Image
              src={service_1}
              ...
              className={cn(
                ...
                formik.values.extra_moving_service === "PACKING_SERVICES" &&
                  "border-secondary",
              )}
            />
            <p
          ...
          <div
            className="flex cursor-pointer flex-col items-center"
            onClick={() =>
              formik.setFieldValue("extra_moving_service", "PACKING_MATERIALS")
            }
          >
            <Image
              src={service_2}
              ...
              className={cn(
                "rounded-full border-2 border-transparent",
                formik.values.extra_moving_service === "PACKING_MATERIALS" &&
                  "border-secondary",
              )}
            />
            <p
          ...
          >
            <Image
              ...
              className={cn(
                "rounded-full border-2 border-transparent",
                formik.values.extra_moving_service ===
                  "DISMANTLING_AND_REASSEMBLING" && "border-secondary",
              )}
            />
            <p
              className={cn(
                "mt-2 w-28 text-center text-sm font-semibold",
                formik.values.extra_moving_service ===
                  "DISMANTLING_AND_REASSEMBLING" && "text-secondary",
              )}
            >
